              ...
              <dl>
                  ...
                  /> SpiceJet </div></dd>
                            ...
                            onKeyDown={(e) => e.key === "Enter" && sortByDuration()}
                                            >
                                                <p className="headlines bg-warning">
                                                  <span className="bg-warning text text-white p-1 mb-1"> {durationAsc ? <FaArrowUp /> : <FaArrowDown />} Shortest Duration :: </span><b class="text-white">{Math.floor(shortDur / 60)} H, {shortDur % 60} m</b>
