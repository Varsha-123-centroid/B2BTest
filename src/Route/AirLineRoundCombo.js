                  ...
                  /> SpiceJet </div></dd>
                    ...
                    <div className="col-md-9">
                            ...
                            onKeyDown={(e) => e.key === "Enter" && sortByEarlyDepart()}
                                            >
                                                <p className="headlines bg-danger">
                                                  <span className="bg-danger text text-white p-1 mb-1">{departAsc ? <FaArrowUp /> : <FaArrowDown />} Early Departure :: </span><b class="text-white">{miniTime}  </b>
