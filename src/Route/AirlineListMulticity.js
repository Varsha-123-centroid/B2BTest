...
const AirlineListMulticity = () => {
    ...
    const [seggm,setSeggm]= useState(0);
  ...
  responseget.Response.Results.forEach((innerArray) => {
    ...
    useEffect(() => {
        ...
        const multicount1=localStorage.getItem('multicount');
        if (multicount1) {
            multicount=multicount1;
          }
    },[]) ;
    useEffect(() => {
  ...
  //  const [result,setResult]=useState(response);
      ...
      if(price11<balance) 
    {
        localStorage.setItem('price', price11);
          ...
          localStorage.setItem('journeyType', 3);
           ...
           <dd className="mt-8-im">
                    ...
                    <div className="col-md-9">
                                        ...
                                        <div className="edit_profileSec">
                                            ...
                                            <thead  style={{backgroundColor: "#184265",color:"#fff"}}>
                                                        ...
                                                        <th>Airline </th>
                                                        <th>Last Trip Departure</th>
                                                        <th>Last Trip Arrival</th>
                                                        <th>Stop</th>
                                                        <th>Price</th>
            ...
            {handbagwt=data?.CabinBaggage}
              ...
              {seats=data?.NoOfSeatAvailable}
                                                                    ...
                                                                    { connectionflightString =connectionflightString+';  ' + originairport + ' → ' + destinationairport}
                                                    ...
                                                    <th style={{ width: "20%", paddingLeft: "1rem", textAlign: "center" }}>
                                                            <img src={`assets/images/AirlineLogo_25x25/${airlineCode}.gif`} style={{height:"80",width:"20%",border: '0px solid black' }} alt=""/>
                                                              ...
                                                              <p>{airlineName}</p>
                                                               ...
                                                               <p>{connectionflightString.substring(1)}</p>
...
export default AirlineListMulticity
